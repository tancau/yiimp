	...
	if (strcmp(coind->symbol, "BMN") == 0)
{
 ...
 //add GLT
  ...
  if(strcmp(coind->symbol, "FLO") == 0){if(coind->txmessage){strcat(templ->coinb2, "00");}} //fixes FlorinCoin
	if(strcmp(coind->symbol, "GIO") == 0){if(coind->txmessage){strcat(templ->coinb2, "00");}}
	if(strcmp(coind->symbol, "EMC2") == 0){if(coind->txmessage){strcat(templ->coinb2, "00");}} //fixes GravioCoin
	strcat(templ->coinb2, "00000000"); // locktime
